var onTextfieldKeyUp = null;
var onTextfieldKeyDown = null;
var onTextfieldKeyPress = null;
var hangulTextbox = null;

function resetHangulBindings() {
  if (hangulTextbox && onTextfieldKeyUp) {
    hangulTextbox.removeEventListener('keyup', onTextfieldKeyUp);
  }
  if (hangulTextbox && onTextfieldKeyDown) {
    hangulTextbox.removeEventListener('keydown', onTextfieldKeyDown);
  }
  if (hangulTextbox && onTextfieldKeyPress) {
    hangulTextbox.removeEventListener('keypress', onTextfieldKeyPress);
  }
...
function hangulKeyboard() {
  ...
  a.keyboard.prototype.wireEvents = function() {
    ...
    e.textbox.addEventListener('keydown', onTextfieldKeyDown);

    if (a.util.opera) {
      onTextfieldKeyPress = function(i) {
        if (e.cancelkeypress) {
          a.util.preventDefault(i);
          e.cancelkeypress = false
        }
      }
      e.textbox.addEventListener('keypress', onTextfieldKeyPress);
    }
    onTextfieldKeyUp = function(t) {
      var i = a.util.code(t);
      if (i == "Unidentified") {
    ...
    e.textbox.addEventListener('keyup', onTextfieldKeyUp);
  };
  var o = false;
  try {
    var d = "item";
